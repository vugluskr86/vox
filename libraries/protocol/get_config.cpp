...
fc::variant_object get_config()
{
   ...
   result["STEEMIT_BLOCK_START_PRINT_SBD_1ST"] = STEEMIT_BLOCK_STOP_PRINT_SBD;
   result["STEEMIT_BLOCK_STOP_PRINT_SBD_1ST"] = STEEMIT_BLOCK_STOP_PRINT_SBD;
   result["STEEMIT_BLOCK_START_PRINT_SBD_2ND"] = STEEMIT_BLOCK_STOP_PRINT_SBD;
   result["STEEMIT_BLOCK_STOP_PRINT_SBD_2ND"] = STEEMIT_BLOCK_STOP_PRINT_SBD;
